...
const ProductCards = ({product}) => {
  ...
  return (
    <div key={product._id} className="bg-white cursor-pointer shadow-md themeColor1 rounded-lg p-3 border border-gray-400" onClick={()=>router.push(`/product/${product._id}`)}>
