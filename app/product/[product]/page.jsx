    ...
    <div className="mt-16 max-w-7xl mx-auto">
      <div className="lg:flex gap-11">
        ...
        <div className="w-full lg:w-96 border rounded px-3 py-1 flex flex-col mx-auto">
          ...
          <h3 className="themeColor1 border inline-block border-white px-2 py-2 border-dashed mt-2 text-white">
            Free delivery
          </h3>
...
export async function generateMetadata({ params }) {
  ...
  try {
    ...
    return {
      title: singleProducts?.name || "Product Details",
      description: singleProducts?.description || "Detailed product description",
    };
  } catch (error) {
